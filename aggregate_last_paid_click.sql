...
SELECT
    ...
    SUM(CASE
        WHEN la.closing_reason = 'Успешно реализовано' OR la.status_id = 142
            THEN la.amount
    END) AS revenue  -- может быть NULL
...
ORDER BY
    ...
    utm_medium ASC,
    utm_campaign ASC" (visit_date,utm_source,utm_medium,utm_campaign,visitors_count,total_cost,leads_count,purchases_count,revenue) VALUES
	 ('2023-06-01','vk','cpc','prof-data-analytics',49,1072,30,0,NULL),
	 ('2023-06-01','vk','cpc','freemium-java',42,487,24,0,NULL),
	 ...
	 ('2023-06-01','vk','cpm','prof-data-analytics',10,385,6,0,NULL),
	 ('2023-06-01','yandex','cpc','prof-professions-retarget',10,1714,10,0,NULL),
...
ORDER BY
    ...
    utm_campaign ASC" (visit_date,utm_source,utm_medium,utm_campaign,visitors_count,total_cost,leads_count,purchases_count,revenue) VALUES
	 ...
	 ('2023-06-01','yandex','cpc','dod-java',4,2906,4,0,NULL),
	 ...
	 ('2023-06-01','yandex','cpc','dod-frontend',3,2871,3,0,NULL),
...
ORDER BY
    ...
    utm_campaign ASC" (visit_date,utm_source,utm_medium,utm_campaign,visitors_count,total_cost,leads_count,purchases_count,revenue) VALUES
	 ...
	 ('2023-06-02','vk','cpc','prof-python',240,2032,0,0,NULL);
INSERT INTO "WITH last_paid_click AS (
    SELECT
        s.visitor_id,
        s.source AS utm_source,
...
ORDER BY
    ...
    utm_medium ASC,
    utm_campaign ASC" (visit_date,utm_source,utm_medium,utm_campaign,visitors_count,total_cost,leads_count,purchases_count,revenue) VALUES
	 ('2023-06-02','vk','cpc','prof-java',216,2783,0,0,NULL),
	 ('2023-06-02','vk','cpc','freemium-frontend',207,2538,0,0,NULL),
	 ('2023-06-02','vk','cpc','prof-data-analytics',178,4060,0,0,NULL),
	 ('2023-06-02','vk','cpc','freemium-java',163,2536,0,0,NULL),
	 ('2023-06-02','vk','cpc','freemium-python',143,1739,0,0,NULL),
	 ('2023-06-02','vk','cpc','base-python',133,2536,0,0,NULL),
...
ORDER BY
    ...
    utm_campaign ASC" (visit_date,utm_source,utm_medium,utm_campaign,visitors_count,total_cost,leads_count,purchases_count,revenue) VALUES
	 ...
	 ('2023-06-03','vk','cpc','freemium-frontend',211,2539,0,0,NULL),
...
ORDER BY
    ...
    utm_medium ASC,
    utm_campaign ASC" (visit_date,utm_source,utm_medium,utm_campaign,visitors_count,total_cost,leads_count,purchases_count,revenue) VALUES
	 ('2023-06-03','vk','cpc','prof-python',204,2023,0,0,NULL),
	 ('2023-06-03','vk','cpc','prof-java',198,2774,0,0,NULL),
	 ('2023-06-03','vk','cpc','prof-data-analytics',172,3974,0,0,NULL),
	 ('2023-06-03','vk','cpc','freemium-java',148,2656,0,0,NULL),
	 ('2023-06-03','vk','cpc','freemium-python',122,1390,0,0,NULL),
	 ('2023-06-03','vk','cpc','prof-frontend',122,NULL,0,0,NULL),
	 ('2023-06-03','vk','cpc','base-python',101,2997,0,0,NULL),
...
ORDER BY
    ...
    utm_campaign ASC" (visit_date,utm_source,utm_medium,utm_campaign,visitors_count,total_cost,leads_count,purchases_count,revenue) VALUES
	 ...
	 ('2023-06-04','vk','cpc','freemium-frontend',224,2538,0,0,NULL),
	 ('2023-06-04','vk','cpc','prof-python',213,2032,0,0,NULL),
	 ('2023-06-04','vk','cpc','prof-java',188,1627,0,0,NULL),
...
ORDER BY
    ...
    utm_medium ASC,
    utm_campaign ASC" (visit_date,utm_source,utm_medium,utm_campaign,visitors_count,total_cost,leads_count,purchases_count,revenue) VALUES
	 ('2023-06-04','vk','cpc','freemium-java',150,1566,0,0,NULL),
	 ('2023-06-04','vk','cpc','base-python',145,2537,0,0,NULL),
	 ('2023-06-04','vk','cpc','prof-data-analytics',132,3740,0,0,NULL),
	 ('2023-06-04','vk','cpc','freemium-python',130,1305,0,0,NULL),
	 ...
	 ('2023-06-04','vk','cpm','prof-data-analytics',24,701,0,0,NULL),
...
ORDER BY
    ...
    utm_campaign ASC" (visit_date,utm_source,utm_medium,utm_campaign,visitors_count,total_cost,leads_count,purchases_count,revenue) VALUES
	 ...
	 ('2023-06-05','vk','cpc','freemium-frontend',192,2538,0,0,NULL),
	 ('2023-06-05','vk','cpc','prof-java',191,2022,0,0,NULL),
	 ('2023-06-05','vk','cpc','prof-python',182,5077,0,0,NULL),
	 ('2023-06-05','vk','cpc','prof-data-analytics',154,3048,0,0,NULL),
	 ('2023-06-05','vk','cpc','freemium-java',138,397,0,0,NULL),
	 ('2023-06-05','vk','cpc','freemium-python',138,1118,0,0,NULL);
INSERT INTO "WITH last_paid_click AS (
    SELECT
        s.visitor_id,
        s.source AS utm_source,
...
ORDER BY
    ...
    utm_medium ASC,
    utm_campaign ASC" (visit_date,utm_source,utm_medium,utm_campaign,visitors_count,total_cost,leads_count,purchases_count,revenue) VALUES
	 ('2023-06-05','vk','cpc','base-python',124,1980,0,0,NULL),
	 ...
	 ('2023-06-05','vk','cpm','prof-data-analytics',23,761,0,0,NULL),
...
ORDER BY
    ...
    utm_medium ASC,
    utm_campaign ASC" (visit_date,utm_source,utm_medium,utm_campaign,visitors_count,total_cost,leads_count,purchases_count,revenue) VALUES
	 ('2023-06-06','vk','cpc','prof-python',185,5078,0,0,NULL),
	 ('2023-06-06','vk','cpc','freemium-frontend',171,3348,0,0,NULL),
	 ('2023-06-06','vk','cpc','prof-java',159,1137,0,0,NULL),
	 ('2023-06-06','vk','cpc','freemium-java',139,1916,0,0,NULL),
	 ('2023-06-06','vk','cpc','prof-data-analytics',135,3044,0,0,NULL),
	 ('2023-06-06','vk','cpc','base-python',121,3301,0,0,NULL),
	 ('2023-06-06','vk','cpc','prof-frontend',111,NULL,0,0,NULL),
	 ('2023-06-06','vk','cpc','freemium-python',104,1854,0,0,NULL),
...
ORDER BY
    ...
    utm_campaign ASC" (visit_date,utm_source,utm_medium,utm_campaign,visitors_count,total_cost,leads_count,purchases_count,revenue) VALUES
	 ...
	 ('2023-06-06','vk','cpm','prof-data-analytics',13,759,0,0,NULL),
...
ORDER BY
    ...
    utm_campaign ASC" (visit_date,utm_source,utm_medium,utm_campaign,visitors_count,total_cost,leads_count,purchases_count,revenue) VALUES
	 ...
	 ('2023-06-07','vk','cpc','prof-python',190,5079,0,0,NULL),
	 ('2023-06-07','vk','cpc','freemium-frontend',169,2535,0,0,NULL),
	 ('2023-06-07','vk','cpc','prof-java',166,1126,0,0,NULL);
INSERT INTO "WITH last_paid_click AS (
    SELECT
        s.visitor_id,
        s.source AS utm_source,
...
ORDER BY
    ...
    utm_medium ASC,
    utm_campaign ASC" (visit_date,utm_source,utm_medium,utm_campaign,visitors_count,total_cost,leads_count,purchases_count,revenue) VALUES
	 ('2023-06-07','vk','cpc','freemium-java',113,2532,0,0,NULL),
	 ('2023-06-07','vk','cpc','freemium-python',111,2916,0,0,NULL),
	 ('2023-06-07','vk','cpc','prof-data-analytics',110,3048,0,0,NULL),
	 ('2023-06-07','vk','cpc','base-python',107,2516,0,0,NULL),
	 ...
	 ('2023-06-07','vk','cpm','prof-data-analytics',12,762,0,0,NULL);
INSERT INTO "WITH last_paid_click AS (
    SELECT
        s.visitor_id,
        s.source AS utm_source,
...
ORDER BY
    ...
    utm_campaign ASC" (visit_date,utm_source,utm_medium,utm_campaign,visitors_count,total_cost,leads_count,purchases_count,revenue) VALUES
	 ...
	 ('2023-06-08','vk','cpc','freemium-frontend',193,2575,0,0,NULL);
INSERT INTO "WITH last_paid_click AS (
    SELECT
        s.visitor_id,
        s.source AS utm_source,
...
ORDER BY
    ...
    utm_medium ASC,
    utm_campaign ASC" (visit_date,utm_source,utm_medium,utm_campaign,visitors_count,total_cost,leads_count,purchases_count,revenue) VALUES
	 ('2023-06-08','vk','cpc','prof-python',188,5076,0,0,NULL),
	 ('2023-06-08','vk','cpc','prof-java',172,1594,0,0,NULL),
	 ('2023-06-08','vk','cpc','prof-data-analytics',135,3013,0,0,NULL),
	 ('2023-06-08','vk','cpc','freemium-java',124,2531,0,0,NULL),
	 ('2023-06-08','vk','cpc','prof-frontend',117,592,0,0,NULL),
	 ('2023-06-08','vk','cpc','base-python',111,1009,0,0,NULL),
	 ('2023-06-08','vk','cpc','freemium-python',108,2532,0,0,NULL),
...
ORDER BY
    ...
    utm_campaign ASC" (visit_date,utm_source,utm_medium,utm_campaign,visitors_count,total_cost,leads_count,purchases_count,revenue) VALUES
	 ...
	 ('2023-06-08','vk','cpm','prof-data-analytics',17,762,0,0,NULL),
...
ORDER BY
    ...
    utm_campaign ASC" (visit_date,utm_source,utm_medium,utm_campaign,visitors_count,total_cost,leads_count,purchases_count,revenue) VALUES
	 ...
	 ('2023-06-09','vk','cpc','prof-python',182,5077,0,0,NULL);
INSERT INTO "WITH last_paid_click AS (
    SELECT
        s.visitor_id,
        s.source AS utm_source,
...
ORDER BY
    ...
    utm_medium ASC,
    utm_campaign ASC" (visit_date,utm_source,utm_medium,utm_campaign,visitors_count,total_cost,leads_count,purchases_count,revenue) VALUES
	 ('2023-06-09','vk','cpc','freemium-frontend',181,2534,0,0,NULL),
	 ('2023-06-09','vk','cpc','prof-java',161,4610,0,0,NULL),
	 ('2023-06-09','vk','cpc','prof-data-analytics',160,4502,0,0,NULL),
	 ('2023-06-09','vk','cpc','freemium-python',120,2533,0,0,NULL),
	 ('2023-06-09','vk','cpc','prof-frontend',112,5077,1,0,NULL),
	 ('2023-06-09','vk','cpc','freemium-java',108,2533,0,0,NULL),
...
ORDER BY
    ...
    utm_medium ASC,
    utm_campaign ASC" (visit_date,utm_source,utm_medium,utm_campaign,visitors_count,total_cost,leads_count,purchases_count,revenue) VALUES
	 ('2023-06-09','vk','cpm','prof-data-analytics',11,64,0,0,NULL),
...
ORDER BY
    ...
    utm_campaign ASC" (visit_date,utm_source,utm_medium,utm_campaign,visitors_count,total_cost,leads_count,purchases_count,revenue) VALUES
	 ...
	 ('2023-06-10','vk','cpc','prof-python',163,5458,0,0,NULL),
	 ('2023-06-10','vk','cpc','freemium-frontend',155,2536,0,0,NULL),
	 ('2023-06-10','vk','cpc','prof-java',150,3743,0,0,NULL),
	 ('2023-06-10','vk','cpc','freemium-python',143,2536,0,0,NULL),
	 ('2023-06-10','vk','cpc','prof-data-analytics',130,4220,0,0,NULL);
INSERT INTO "WITH last_paid_click AS (
    SELECT
        s.visitor_id,
        s.source AS utm_source,
...
ORDER BY
    ...
    utm_campaign ASC" (visit_date,utm_source,utm_medium,utm_campaign,visitors_count,total_cost,leads_count,purchases_count,revenue) VALUES
	 ...
	 ('2023-06-10','vk','cpc','freemium-java',107,2537,0,0,NULL),
	 ('2023-06-10','vk','cpc','prof-frontend',96,5458,0,0,NULL),
...
ORDER BY
    ...
    utm_campaign ASC" (visit_date,utm_source,utm_medium,utm_campaign,visitors_count,total_cost,leads_count,purchases_count,revenue) VALUES
	 ...
	 ('2023-06-11','vk','cpc','freemium-frontend',211,2533,0,0,NULL),
	 ('2023-06-11','vk','cpc','prof-python',186,5076,0,0,NULL);
INSERT INTO "WITH last_paid_click AS (
    SELECT
        s.visitor_id,
        s.source AS utm_source,
...
ORDER BY
    ...
    utm_medium ASC,
    utm_campaign ASC" (visit_date,utm_source,utm_medium,utm_campaign,visitors_count,total_cost,leads_count,purchases_count,revenue) VALUES
	 ('2023-06-11','vk','cpc','prof-java',147,3781,0,0,NULL),
	 ('2023-06-11','vk','cpc','prof-data-analytics',141,4569,0,0,NULL),
	 ('2023-06-11','vk','cpc','freemium-java',126,2916,0,0,NULL),
	 ('2023-06-11','vk','cpc','prof-frontend',123,5458,0,0,NULL),
	 ('2023-06-11','vk','cpc','base-python',115,NULL,0,0,NULL),
	 ('2023-06-11','vk','cpc','freemium-python',112,2536,0,0,NULL),
...
ORDER BY
    ...
    utm_campaign ASC" (visit_date,utm_source,utm_medium,utm_campaign,visitors_count,total_cost,leads_count,purchases_count,revenue) VALUES
	 ...
	 ('2023-06-12','vk','cpc','prof-python',196,5202,0,0,NULL),
	 ('2023-06-12','vk','cpc','freemium-frontend',184,3170,0,0,NULL),
	 ('2023-06-12','vk','cpc','prof-java',170,4105,0,0,NULL),
	 ('2023-06-12','vk','cpc','prof-data-analytics',161,4187,0,0,NULL),
	 ('2023-06-12','vk','cpc','freemium-java',132,4822,0,0,NULL),
	 ('2023-06-12','vk','cpc','base-python',123,NULL,0,0,NULL),
	 ('2023-06-12','vk','cpc','freemium-python',121,2536,0,0,NULL);
INSERT INTO "WITH last_paid_click AS (
    SELECT
        s.visitor_id,
        s.source AS utm_source,
...
ORDER BY
    ...
    utm_medium ASC,
    utm_campaign ASC" (visit_date,utm_source,utm_medium,utm_campaign,visitors_count,total_cost,leads_count,purchases_count,revenue) VALUES
	 ('2023-06-12','vk','cpc','prof-frontend',113,5078,0,0,NULL),
...
ORDER BY
    ...
    utm_medium ASC,
    utm_campaign ASC" (visit_date,utm_source,utm_medium,utm_campaign,visitors_count,total_cost,leads_count,purchases_count,revenue) VALUES
	 ('2023-06-13','yandex','cpc','freemium',138,18523,0,0,NULL),
	 ('2023-06-13','yandex','cpc','prof-frontend',105,62685,0,0,NULL),
	 ('2023-06-13','yandex','cpc','prof-python',104,43241,0,0,NULL),
	 ('2023-06-13','yandex','cpc','prof-java',83,36520,0,0,NULL),
	 ('2023-06-13','vk','cpc','prof-python',66,5202,0,0,NULL),
	 ('2023-06-13','vk','cpc','freemium-frontend',62,2746,1,0,NULL),
	 ('2023-06-13','vk','cpc','freemium-java',57,2377,0,0,NULL),
	 ('2023-06-13','vk','cpc','freemium-python',52,2538,0,0,NULL),
	 ('2023-06-13','vk','cpc','prof-data-analytics',49,4188,0,0,NULL),
	 ('2023-06-13','vk','cpc','prof-java',47,4350,1,0,NULL);
INSERT INTO "WITH last_paid_click AS (
    SELECT
        s.visitor_id,
        s.source AS utm_source,
...
ORDER BY
    ...
    utm_campaign ASC" (visit_date,utm_source,utm_medium,utm_campaign,visitors_count,total_cost,leads_count,purchases_count,revenue) VALUES
	 ...
	 ('2023-06-13','vk','cpc','prof-frontend',37,5459,0,0,NULL),
	 ('2023-06-13','yandex','cpc','base-python',35,NULL,0,0,NULL),
	 ('2023-06-13','yandex','cpc','prof-professions-brand',33,3574,0,0,NULL),
	 ('2023-06-13','yandex','cpc','base-frontend',29,10232,0,0,NULL),
	 ('2023-06-13','telegram','cpp','base-frontend',21,NULL,0,0,NULL),
	 ('2023-06-13','yandex','cpc','prof-professions-retarget',18,604,0,0,NULL),
	 ('2023-06-13','yandex','cpc','prof-data-analytics',17,6033,0,0,NULL);
INSERT INTO "WITH last_paid_click AS (
    SELECT
        s.visitor_id,
        s.source AS utm_source,
...
ORDER BY
    ...
    utm_campaign ASC" (visit_date,utm_source,utm_medium,utm_campaign,visitors_count,total_cost,leads_count,purchases_count,revenue) VALUES
	 ...
	 ('2023-06-13','yandex','cpc','dod-professions',12,3905,0,0,NULL),
	 ('2023-06-13','yandex','cpc','dod-frontend',10,4123,0,0,NULL),
	 ('2023-06-13','yandex','cpc','dod-python-java',9,NULL,0,0,NULL),
	 ('2023-06-13','telegram','cpp','prof-java',8,NULL,0,0,NULL),
	 ('2023-06-13','yandex','cpc','base-professions-retarget',5,808,0,0,NULL),
...
ORDER BY
    ...
    utm_medium ASC,
    utm_campaign ASC" (visit_date,utm_source,utm_medium,utm_campaign,visitors_count,total_cost,leads_count,purchases_count,revenue) VALUES
	 ('2023-06-14','yandex','cpc','freemium',215,18752,0,0,NULL),
	 ('2023-06-14','yandex','cpc','prof-python',170,41766,0,0,NULL),
	 ('2023-06-14','yandex','cpc','prof-frontend',165,70624,0,0,NULL),
	 ('2023-06-14','yandex','cpc','prof-java',163,37151,0,0,NULL),
	 ('2023-06-14','yandex','cpc','base-java',57,NULL,0,0,NULL),
	 ('2023-06-14','yandex','cpc','base-python',53,NULL,0,0,NULL),
	 ('2023-06-14','yandex','cpc','prof-professions-brand',49,3580,0,0,NULL),
...
ORDER BY
    ...
    utm_medium ASC,
    utm_campaign ASC" (visit_date,utm_source,utm_medium,utm_campaign,visitors_count,total_cost,leads_count,purchases_count,revenue) VALUES
	 ('2023-06-14','yandex','cpc','prof-data-analytics',32,8854,0,0,NULL),
	 ('2023-06-14','yandex','cpc','prof-professions-retarget',27,694,0,0,NULL),
	 ('2023-06-14','telegram','social','dod-professions',21,NULL,1,0,NULL),
	 ('2023-06-14','vk-senler','cpc','freemium',15,NULL,0,0,NULL),
	 ('2023-06-14','yandex','cpc','dod-frontend',15,984,0,0,NULL),
	 ...
	 ('2023-06-14','yandex','cpc','dod-professions',12,1471,0,0,NULL),
	 ('2023-06-14','vk','cpc','prof-data-analytics',10,4189,0,0,NULL);
INSERT INTO "WITH last_paid_click AS (
    SELECT
        s.visitor_id,
        s.source AS utm_source,
...
ORDER BY
    ...
    utm_medium ASC,
    utm_campaign ASC" (visit_date,utm_source,utm_medium,utm_campaign,visitors_count,total_cost,leads_count,purchases_count,revenue) VALUES
	 ('2023-06-14','vk','cpc','freemium-frontend',8,2479,0,0,NULL),
	 ('2023-06-14','vk','cpc','freemium-python',8,2895,0,0,NULL),
	 ('2023-06-14','yandex','cpc','base-professions-retarget',8,722,0,0,NULL),
	 ('2023-06-14','yandex','cpc','dod-php',8,NULL,0,0,NULL),
	 ('2023-06-14','vk','cpp','dod-frontend',7,NULL,0,0,NULL),
	 ('2023-06-14','yandex','cpc','dod-python-java',7,909,0,0,NULL),
	 ('2023-06-14','yandex','cpc','dod-qa',7,NULL,0,0,NULL),
	 ('2023-06-14','vk','cpc','prof-frontend',5,5077,0,0,NULL),
	 ('2023-06-14','vk','cpc','prof-java',5,4112,0,0,NULL),
	 ('2023-06-14','vk','cpc','prof-python',5,5074,0,0,NULL);
INSERT INTO "WITH last_paid_click AS (
    SELECT
        s.visitor_id,
        s.source AS utm_source,
...
ORDER BY
    ...
    utm_campaign ASC" (visit_date,utm_source,utm_medium,utm_campaign,visitors_count,total_cost,leads_count,purchases_count,revenue) VALUES
	 ...
	 ('2023-06-15','yandex','cpc','freemium',238,15317,0,0,NULL),
	 ('2023-06-15','yandex','cpc','prof-frontend',164,69171,0,0,NULL),
	 ('2023-06-15','yandex','cpc','prof-python',156,41982,0,0,NULL),
	 ('2023-06-15','yandex','cpc','prof-java',130,34902,0,0,NULL),
	 ('2023-06-15','yandex','cpc','base-java',61,NULL,0,0,NULL),
	 ('2023-06-15','yandex','cpc','base-python',49,NULL,0,0,NULL),
	 ('2023-06-15','yandex','cpc','prof-professions-brand',49,5511,0,0,NULL);
INSERT INTO "WITH last_paid_click AS (
    SELECT
        s.visitor_id,
        s.source AS utm_source,
...
ORDER BY
    ...
    utm_campaign ASC" (visit_date,utm_source,utm_medium,utm_campaign,visitors_count,total_cost,leads_count,purchases_count,revenue) VALUES
	 ...
	 ('2023-06-15','yandex','cpc','prof-data-analytics',28,6556,0,0,NULL),
	 ('2023-06-15','yandex','cpc','prof-professions-retarget',27,1290,0,0,NULL),
	 ('2023-06-15','yandex','cpc','dod-frontend',20,908,0,0,NULL),
	 ('2023-06-15','yandex','cpc','dod-professions',17,3925,0,0,NULL),
	 ('2023-06-15','vk-senler','cpc','freemium',14,NULL,0,0,NULL),
	 ('2023-06-15','telegram','cpp','base-frontend',12,NULL,0,0,NULL),
	 ('2023-06-15','yandex','cpc','dod-python-java',10,4554,0,0,NULL),
	 ('2023-06-15','vk','cpc','freemium-python',9,2536,0,0,NULL);
INSERT INTO "WITH last_paid_click AS (
    SELECT
        s.visitor_id,
        s.source AS utm_source,
...
ORDER BY
    ...
    utm_medium ASC,
    utm_campaign ASC" (visit_date,utm_source,utm_medium,utm_campaign,visitors_count,total_cost,leads_count,purchases_count,revenue) VALUES
	 ('2023-06-15','vk','cpc','prof-frontend',5,4688,1,0,NULL),
	 ('2023-06-15','telegram','social','dod-professions',3,NULL,0,0,NULL),
	 ('2023-06-15','vk','cpc','prof-python',3,5837,0,0,NULL),
...
ORDER BY
    ...
    utm_campaign ASC" (visit_date,utm_source,utm_medium,utm_campaign,visitors_count,total_cost,leads_count,purchases_count,revenue) VALUES
	 ...
	 ('2023-06-16','yandex','cpc','freemium',233,17913,0,0,NULL),
	 ('2023-06-16','yandex','cpc','prof-python',168,39215,0,0,NULL),
	 ('2023-06-16','yandex','cpc','prof-frontend',137,58935,0,0,NULL),
	 ('2023-06-16','yandex','cpc','prof-java',112,36459,0,0,NULL),
	 ('2023-06-16','yandex','cpc','base-java',59,NULL,0,0,NULL),
	 ('2023-06-16','yandex','cpc','base-python',51,NULL,0,0,NULL),
	 ('2023-06-16','yandex','cpc','prof-professions-brand',48,5794,0,0,NULL),
...
ORDER BY
    ...
    utm_medium ASC,
    utm_campaign ASC" (visit_date,utm_source,utm_medium,utm_campaign,visitors_count,total_cost,leads_count,purchases_count,revenue) VALUES
	 ('2023-06-16','yandex','cpc','prof-data-analytics',39,5576,0,0,NULL),
	 ('2023-06-16','admitad','cpa','admitad',37,NULL,0,0,NULL),
	 ('2023-06-16','yandex','cpc','prof-professions-retarget',35,1085,0,0,NULL),
	 ('2023-06-16','yandex','cpc','dod-frontend',22,NULL,0,0,NULL),
	 ('2023-06-16','yandex','cpc','dod-professions',15,3077,0,0,NULL),
	 ('2023-06-16','vk','cpc','prof-data-analytics',13,4594,0,0,NULL),
	 ('2023-06-16','vk','cpc','prof-python',13,5838,0,0,NULL),
...
ORDER BY
    ...
    utm_campaign ASC" (visit_date,utm_source,utm_medium,utm_campaign,visitors_count,total_cost,leads_count,purchases_count,revenue) VALUES
	 ...
	 ('2023-06-16','vk','cpc','prof-java',9,4427,1,0,NULL),
	 ('2023-06-16','vk','cpc','prof-frontend',8,5458,1,0,NULL),
	 ('2023-06-16','vk','cpc','freemium-java',7,2398,0,0,NULL),
	 ('2023-06-16','yandex','cpc','dod-php',6,NULL,0,0,NULL),
	 ('2023-06-16','telegram','cpp','prof-python',5,NULL,0,0,NULL),
	 ('2023-06-16','vk','cpc','freemium-python',5,2537,0,0,NULL),
	 ('2023-06-16','yandex','cpc','dod-python-java',5,3259,0,0,NULL),
...
ORDER BY
    ...
    utm_medium ASC,
    utm_campaign ASC" (visit_date,utm_source,utm_medium,utm_campaign,visitors_count,total_cost,leads_count,purchases_count,revenue) VALUES
	 ('2023-06-16','vk','cpc','freemium-frontend',4,2535,0,0,NULL),
...
ORDER BY
    ...
    utm_campaign ASC" (visit_date,utm_source,utm_medium,utm_campaign,visitors_count,total_cost,leads_count,purchases_count,revenue) VALUES
	 ...
	 ('2023-06-17','yandex','cpc','freemium',200,14413,0,0,NULL);
INSERT INTO "WITH last_paid_click AS (
    SELECT
        s.visitor_id,
        s.source AS utm_source,
...
ORDER BY
    ...
    utm_medium ASC,
    utm_campaign ASC" (visit_date,utm_source,utm_medium,utm_campaign,visitors_count,total_cost,leads_count,purchases_count,revenue) VALUES
	 ('2023-06-17','yandex','cpc','prof-python',174,45139,0,0,NULL),
	 ('2023-06-17','yandex','cpc','prof-frontend',132,59871,0,0,NULL),
	 ('2023-06-17','yandex','cpc','prof-java',131,27510,0,0,NULL),
	 ('2023-06-17','yandex','cpc','base-python',63,NULL,0,0,NULL),
	 ('2023-06-17','yandex','cpc','prof-professions-brand',58,3878,0,0,NULL),
	 ...
	 ('2023-06-17','yandex','cpc','prof-data-analytics',34,7663,0,0,NULL),
	 ('2023-06-17','yandex','cpc','dod-professions',25,4770,0,0,NULL);
INSERT INTO "WITH last_paid_click AS (
    SELECT
        s.visitor_id,
        s.source AS utm_source,
...
ORDER BY
    ...
    utm_medium ASC,
    utm_campaign ASC" (visit_date,utm_source,utm_medium,utm_campaign,visitors_count,total_cost,leads_count,purchases_count,revenue) VALUES
	 ('2023-06-17','yandex','cpc','prof-professions-retarget',22,1103,0,0,NULL),
	 ...
	 ('2023-06-17','yandex','cpc','dod-python-java',9,2138,0,0,NULL),
	 ('2023-06-17','telegram','cpp','base-frontend',8,NULL,0,0,NULL),
	 ('2023-06-17','vk','cpc','prof-python',8,7362,0,0,NULL),
	 ('2023-06-17','yandex','cpc','base-professions-retarget',8,NULL,0,0,NULL),
	 ('2023-06-17','vk','cpc','prof-frontend',7,4974,0,0,NULL);
INSERT INTO "WITH last_paid_click AS (
    SELECT
        s.visitor_id,
        s.source AS utm_source,
...
ORDER BY
    ...
    utm_medium ASC,
    utm_campaign ASC" (visit_date,utm_source,utm_medium,utm_campaign,visitors_count,total_cost,leads_count,purchases_count,revenue) VALUES
	 ('2023-06-17','vk','cpc','prof-java',6,4124,0,0,NULL),
	 ('2023-06-17','yandex','cpc','dod-java',6,NULL,0,0,NULL),
	 ('2023-06-17','vk','cpc','freemium-java',5,1522,0,0,NULL),
	 ('2023-06-17','vk','cpc','prof-data-analytics',5,5327,0,0,NULL),
	 ('2023-06-17','vk','social','dod-professions',5,NULL,0,0,NULL),
	 ('2023-06-17','vk','cpc','freemium-frontend',4,2536,0,0,NULL),
	 ('2023-06-17','vk','cpc','freemium-python',4,2537,0,0,NULL),
...
ORDER BY
    ...
    utm_campaign ASC" (visit_date,utm_source,utm_medium,utm_campaign,visitors_count,total_cost,leads_count,purchases_count,revenue) VALUES
	 ...
	 ('2023-06-18','yandex','cpc','freemium',219,16798,0,0,NULL);
INSERT INTO "WITH last_paid_click AS (
    SELECT
        s.visitor_id,
        s.source AS utm_source,
...
ORDER BY
    ...
    utm_medium ASC,
    utm_campaign ASC" (visit_date,utm_source,utm_medium,utm_campaign,visitors_count,total_cost,leads_count,purchases_count,revenue) VALUES
	 ('2023-06-18','yandex','cpc','prof-python',163,39233,0,0,NULL),
	 ('2023-06-18','yandex','cpc','prof-frontend',149,50806,0,0,NULL),
	 ('2023-06-18','yandex','cpc','prof-java',111,28605,0,0,NULL),
	 ('2023-06-18','yandex','cpc','base-java',61,NULL,0,0,NULL),
	 ('2023-06-18','yandex','cpc','prof-professions-brand',51,3300,0,0,NULL),
	 ...
	 ('2023-06-18','yandex','cpc','prof-data-analytics',27,6446,0,0,NULL),
	 ('2023-06-18','yandex','cpc','prof-professions-retarget',25,1491,0,0,NULL);
INSERT INTO "WITH last_paid_click AS (
    SELECT
        s.visitor_id,
        s.source AS utm_source,
...
ORDER BY
    ...
    utm_campaign ASC" (visit_date,utm_source,utm_medium,utm_campaign,visitors_count,total_cost,leads_count,purchases_count,revenue) VALUES
	 ...
	 ('2023-06-18','yandex','cpc','dod-professions',14,7438,0,0,NULL),
	 ...
	 ('2023-06-18','vk','cpc','prof-data-analytics',9,3579,0,0,NULL),
	 ...
	 ('2023-06-18','yandex','cpc','dod-python-java',8,3374,0,0,NULL);
INSERT INTO "WITH last_paid_click AS (
    SELECT
        s.visitor_id,
        s.source AS utm_source,
...
ORDER BY
    ...
    utm_medium ASC,
    utm_campaign ASC" (visit_date,utm_source,utm_medium,utm_campaign,visitors_count,total_cost,leads_count,purchases_count,revenue) VALUES
	 ('2023-06-18','vk','cpc','freemium-python',6,2536,0,0,NULL),
	 ('2023-06-18','vk','cpc','prof-java',6,4663,0,0,NULL),
	 ('2023-06-18','vk','cpc','freemium-frontend',5,2535,0,0,NULL),
	 ('2023-06-18','vk','cpc','prof-python',4,4591,0,0,NULL),
...
ORDER BY
    ...
    utm_medium ASC,
    utm_campaign ASC" (visit_date,utm_source,utm_medium,utm_campaign,visitors_count,total_cost,leads_count,purchases_count,revenue) VALUES
	 ('2023-06-18','vk','cpc','prof-frontend',2,2912,0,0,NULL),
...
ORDER BY
    ...
    utm_campaign ASC" (visit_date,utm_source,utm_medium,utm_campaign,visitors_count,total_cost,leads_count,purchases_count,revenue) VALUES
	 ...
	 ('2023-06-19','yandex','cpc','freemium',239,17212,0,0,NULL),
	 ('2023-06-19','yandex','cpc','prof-python',185,45990,0,0,NULL),
	 ('2023-06-19','yandex','cpc','prof-java',143,35136,0,0,NULL),
	 ('2023-06-19','yandex','cpc','prof-frontend',135,72966,0,0,NULL),
	 ('2023-06-19','yandex','cpc','base-java',66,NULL,0,0,NULL),
	 ('2023-06-19','yandex','cpc','base-python',60,NULL,0,0,NULL),
	 ('2023-06-19','yandex','cpc','prof-professions-brand',45,3111,0,0,NULL),
...
ORDER BY
    ...
    utm_campaign ASC" (visit_date,utm_source,utm_medium,utm_campaign,visitors_count,total_cost,leads_count,purchases_count,revenue) VALUES
	 ...
	 ('2023-06-19','yandex','cpc','prof-data-analytics',35,6048,0,0,NULL),
	 ('2023-06-19','yandex','cpc','dod-frontend',18,NULL,0,0,NULL),
	 ('2023-06-19','yandex','cpc','prof-professions-retarget',18,1057,0,0,NULL),
	 ('2023-06-19','vk','cpc','prof-python',15,4934,0,0,NULL),
	 ('2023-06-19','yandex','cpc','base-professions-retarget',14,NULL,0,0,NULL),
	 ('2023-06-19','vk-senler','cpc','freemium',12,NULL,0,0,NULL),
	 ('2023-06-19','vk','cpc','prof-java',10,5469,0,0,NULL),
	 ('2023-06-19','vk','cpc','prof-frontend',9,5078,0,0,NULL),
...
ORDER BY
    ...
    utm_medium ASC,
    utm_campaign ASC" (visit_date,utm_source,utm_medium,utm_campaign,visitors_count,total_cost,leads_count,purchases_count,revenue) VALUES
	 ('2023-06-19','vk','cpc','freemium-python',8,2479,0,0,NULL),
	 ('2023-06-19','vk','cpc','prof-data-analytics',8,5326,0,0,NULL),
	 ('2023-06-19','yandex','cpc','dod-python-java',8,2012,0,0,NULL),
	 ...
	 ('2023-06-19','yandex','cpc','dod-professions',6,3683,0,0,NULL),
	 ...
	 ('2023-06-19','vk','cpc','freemium-java',3,2423,0,0,NULL);
INSERT INTO "WITH last_paid_click AS (
    SELECT
        s.visitor_id,
        s.source AS utm_source,
...
ORDER BY
    ...
    utm_campaign ASC" (visit_date,utm_source,utm_medium,utm_campaign,visitors_count,total_cost,leads_count,purchases_count,revenue) VALUES
	 ...
	 ('2023-06-19','vk','cpc','freemium-frontend',2,2536,0,0,NULL),
...
ORDER BY
    ...
    utm_campaign ASC" (visit_date,utm_source,utm_medium,utm_campaign,visitors_count,total_cost,leads_count,purchases_count,revenue) VALUES
	 ...
	 ('2023-06-20','yandex','cpc','freemium',242,16145,0,0,NULL),
	 ('2023-06-20','yandex','cpc','prof-python',184,46055,0,0,NULL),
	 ('2023-06-20','yandex','cpc','prof-frontend',148,68549,0,0,NULL);
INSERT INTO "WITH last_paid_click AS (
    SELECT
        s.visitor_id,
        s.source AS utm_source,
...
ORDER BY
    ...
    utm_medium ASC,
    utm_campaign ASC" (visit_date,utm_source,utm_medium,utm_campaign,visitors_count,total_cost,leads_count,purchases_count,revenue) VALUES
	 ('2023-06-20','yandex','cpc','prof-java',119,28063,0,0,NULL),
	 ('2023-06-20','yandex','cpc','base-python',58,NULL,0,0,NULL),
	 ('2023-06-20','yandex','cpc','base-java',53,3805,0,0,NULL),
	 ('2023-06-20','yandex','cpc','prof-professions-brand',47,3263,0,0,NULL),
	 ('2023-06-20','admitad','cpa','admitad',43,NULL,1,0,NULL),
	 ('2023-06-20','yandex','cpc','prof-data-analytics',38,6795,0,0,NULL),
	 ('2023-06-20','yandex','cpc','base-frontend',33,NULL,0,0,NULL),
	 ('2023-06-20','yandex','cpc','prof-professions-retarget',27,784,0,0,NULL),
	 ('2023-06-20','yandex','cpc','dod-frontend',17,NULL,0,0,NULL),
	 ('2023-06-20','yandex','cpc','dod-professions',17,6422,0,0,NULL);
INSERT INTO "WITH last_paid_click AS (
    SELECT
        s.visitor_id,
        s.source AS utm_source,
...
ORDER BY
    ...
    utm_campaign ASC" (visit_date,utm_source,utm_medium,utm_campaign,visitors_count,total_cost,leads_count,purchases_count,revenue) VALUES
	 ...
	 ('2023-06-20','vk','cpc','prof-python',13,5839,0,0,NULL),
	 ('2023-06-20','vk','cpc','freemium-frontend',11,2851,0,0,NULL),
	 ('2023-06-20','yandex','cpc','dod-python-java',10,3269,0,0,NULL),
	 ('2023-06-20','vk','cpc','freemium-java',8,2538,0,0,NULL),
	 ('2023-06-20','vk','cpc','prof-java',8,5205,0,0,NULL),
...
ORDER BY
    ...
    utm_campaign ASC" (visit_date,utm_source,utm_medium,utm_campaign,visitors_count,total_cost,leads_count,purchases_count,revenue) VALUES
	 ...
	 ('2023-06-20','vk','cpc','prof-data-analytics',5,4941,0,0,NULL),
	 ...
	 ('2023-06-20','vk','cpc','freemium-python',3,2127,0,0,NULL),
	 ('2023-06-20','vk','cpc','prof-frontend',3,5078,0,0,NULL),
...
ORDER BY
    ...
    utm_campaign ASC" (visit_date,utm_source,utm_medium,utm_campaign,visitors_count,total_cost,leads_count,purchases_count,revenue) VALUES
	 ...
	 ('2023-06-21','yandex','cpc','freemium',225,18973,0,0,NULL),
	 ('2023-06-21','yandex','cpc','prof-python',155,46840,0,0,NULL),
	 ('2023-06-21','yandex','cpc','prof-frontend',140,64454,0,0,NULL),
	 ('2023-06-21','yandex','cpc','prof-java',126,29144,0,0,NULL),
	 ('2023-06-21','yandex','cpc','base-java',59,5157,0,0,NULL);
INSERT INTO "WITH last_paid_click AS (
    SELECT
        s.visitor_id,
        s.source AS utm_source,
...
ORDER BY
    ...
    utm_campaign ASC" (visit_date,utm_source,utm_medium,utm_campaign,visitors_count,total_cost,leads_count,purchases_count,revenue) VALUES
	 ...
	 ('2023-06-21','yandex','cpc','base-python',44,4741,0,0,NULL),
	 ('2023-06-21','yandex','cpc','prof-professions-brand',42,4320,0,0,NULL),
	 ('2023-06-21','yandex','cpc','prof-data-analytics',32,3920,0,0,NULL),
	 ('2023-06-21','yandex','cpc','prof-professions-retarget',25,874,0,0,NULL),
	 ('2023-06-21','vk','cpc','prof-python',18,5890,0,0,NULL),
	 ('2023-06-21','yandex','cpc','dod-frontend',16,NULL,0,0,NULL),
	 ('2023-06-21','vk','cpc','prof-data-analytics',13,6090,0,0,NULL),
...
ORDER BY
    ...
    utm_campaign ASC" (visit_date,utm_source,utm_medium,utm_campaign,visitors_count,total_cost,leads_count,purchases_count,revenue) VALUES
	 ...
	 ('2023-06-21','yandex','cpc','dod-python-java',12,2006,0,0,NULL),
	 ...
	 ('2023-06-21','vk','cpc','prof-frontend',9,5079,0,0,NULL),
	 ('2023-06-21','yandex','cpc','dod-qa',9,NULL,0,0,NULL),
	 ('2023-06-21','vk','cpc','prof-java',8,5257,0,0,NULL),
	 ('2023-06-21','vk','cpc','freemium-frontend',7,2537,0,0,NULL),
...
ORDER BY
    ...
    utm_campaign ASC" (visit_date,utm_source,utm_medium,utm_campaign,visitors_count,total_cost,leads_count,purchases_count,revenue) VALUES
	 ...
	 ('2023-06-22','yandex','cpc','freemium',251,14680,0,0,NULL),
	 ('2023-06-22','yandex','cpc','prof-frontend',175,69976,0,0,NULL),
	 ('2023-06-22','yandex','cpc','prof-python',163,50579,0,0,NULL),
	 ('2023-06-22','yandex','cpc','prof-java',129,35881,0,0,NULL),
	 ('2023-06-22','admitad','cpa','admitad',67,NULL,0,0,NULL),
	 ('2023-06-22','yandex','cpc','base-java',66,8185,0,0,NULL),
	 ('2023-06-22','yandex','cpc','base-python',65,3986,0,0,NULL),
	 ('2023-06-22','yandex','cpc','base-frontend',51,NULL,0,0,NULL),
	 ('2023-06-22','yandex','cpc','prof-professions-brand',41,4161,0,0,NULL);
INSERT INTO "WITH last_paid_click AS (
    SELECT
        s.visitor_id,
        s.source AS utm_source,
...
ORDER BY
    ...
    utm_medium ASC,
    utm_campaign ASC" (visit_date,utm_source,utm_medium,utm_campaign,visitors_count,total_cost,leads_count,purchases_count,revenue) VALUES
	 ('2023-06-22','yandex','cpc','prof-data-analytics',29,1462,0,0,NULL),
	 ('2023-06-22','yandex','cpc','dod-frontend',20,NULL,0,0,NULL),
	 ('2023-06-22','yandex','cpc','prof-professions-retarget',19,1073,0,0,NULL),
	 ('2023-06-22','vk-senler','cpc','freemium',18,NULL,0,0,NULL),
	 ('2023-06-22','vk','cpc','prof-python',17,5525,0,0,NULL),
	 ('2023-06-22','vk','cpc','prof-java',13,4223,0,0,NULL),
	 ('2023-06-22','yandex','cpc','dod-professions',12,NULL,0,0,NULL),
	 ('2023-06-22','yandex','cpc','dod-php',11,NULL,0,0,NULL),
	 ('2023-06-22','yandex','cpc','dod-python-java',10,4988,0,0,NULL),
	 ('2023-06-22','vk','cpc','freemium-frontend',9,2623,0,0,NULL);
INSERT INTO "WITH last_paid_click AS (
    SELECT
        s.visitor_id,
        s.source AS utm_source,
...
ORDER BY
    ...
    utm_medium ASC,
    utm_campaign ASC" (visit_date,utm_source,utm_medium,utm_campaign,visitors_count,total_cost,leads_count,purchases_count,revenue) VALUES
	 ('2023-06-22','vk','cpc','prof-data-analytics',9,5964,0,0,NULL),
	 ('2023-06-22','telegram','cpp','prof-java',7,NULL,0,0,NULL),
	 ('2023-06-22','vk','cpc','prof-frontend',7,3684,0,0,NULL),
	 ...
	 ('2023-06-22','vk','cpc','freemium-java',4,2144,0,0,NULL),
...
ORDER BY
    ...
    utm_medium ASC,
    utm_campaign ASC" (visit_date,utm_source,utm_medium,utm_campaign,visitors_count,total_cost,leads_count,purchases_count,revenue) VALUES
	 ('2023-06-22','vk','cpc','freemium-python',3,1872,0,0,NULL),
...
ORDER BY
    ...
    utm_campaign ASC" (visit_date,utm_source,utm_medium,utm_campaign,visitors_count,total_cost,leads_count,purchases_count,revenue) VALUES
	 ...
	 ('2023-06-23','yandex','cpc','freemium',255,18235,0,0,NULL),
	 ('2023-06-23','yandex','cpc','prof-python',207,41643,0,0,NULL),
	 ('2023-06-23','yandex','cpc','prof-frontend',182,56368,0,0,NULL),
	 ('2023-06-23','yandex','cpc','prof-java',134,34444,0,0,NULL);
INSERT INTO "WITH last_paid_click AS (
    SELECT
        s.visitor_id,
        s.source AS utm_source,
...
ORDER BY
    ...
    utm_medium ASC,
    utm_campaign ASC" (visit_date,utm_source,utm_medium,utm_campaign,visitors_count,total_cost,leads_count,purchases_count,revenue) VALUES
	 ('2023-06-23','yandex','cpc','base-java',71,10843,0,0,NULL),
	 ('2023-06-23','yandex','cpc','base-python',66,8276,0,0,NULL),
	 ('2023-06-23','yandex','cpc','base-frontend',58,NULL,0,0,NULL),
	 ('2023-06-23','yandex','cpc','prof-professions-brand',49,4029,0,0,NULL),
	 ('2023-06-23','yandex','cpc','prof-data-analytics',43,8165,0,0,NULL),
	 ('2023-06-23','admitad','cpa','admitad',36,NULL,1,0,NULL),
	 ('2023-06-23','telegram','social','hexlet-blog',36,NULL,0,0,NULL),
	 ('2023-06-23','yandex','cpc','prof-professions-retarget',34,1274,0,0,NULL),
...
ORDER BY
    ...
    utm_campaign ASC" (visit_date,utm_source,utm_medium,utm_campaign,visitors_count,total_cost,leads_count,purchases_count,revenue) VALUES
	 ...
	 ('2023-06-23','vk','cpc','prof-data-analytics',16,4952,0,0,NULL),
	 ('2023-06-23','vk','cpc','prof-python',16,4149,0,0,NULL),
	 ('2023-06-23','vk-senler','cpc','freemium',16,NULL,0,0,NULL),
	 ('2023-06-23','vk','cpc','prof-frontend',11,3807,0,0,NULL),
	 ('2023-06-23','vk','cpc','freemium-frontend',9,2539,0,0,NULL),
	 ('2023-06-23','yandex','cpc','dod-python-java',9,676,0,0,NULL),
...
ORDER BY
    ...
    utm_campaign ASC" (visit_date,utm_source,utm_medium,utm_campaign,visitors_count,total_cost,leads_count,purchases_count,revenue) VALUES
	 ...
	 ('2023-06-23','vk','cpc','freemium-java',6,2539,0,0,NULL),
	 ('2023-06-23','vk','cpc','base-python',5,2284,0,0,NULL),
	 ('2023-06-23','vk','cpc','prof-java',5,6346,0,0,NULL),
...
ORDER BY
    ...
    utm_campaign ASC" (visit_date,utm_source,utm_medium,utm_campaign,visitors_count,total_cost,leads_count,purchases_count,revenue) VALUES
	 ...
	 ('2023-06-24','yandex','cpc','freemium',263,14330,0,0,NULL),
	 ('2023-06-24','yandex','cpc','prof-frontend',172,52548,0,0,NULL);
INSERT INTO "WITH last_paid_click AS (
    SELECT
        s.visitor_id,
        s.source AS utm_source,
...
ORDER BY
    ...
    utm_medium ASC,
    utm_campaign ASC" (visit_date,utm_source,utm_medium,utm_campaign,visitors_count,total_cost,leads_count,purchases_count,revenue) VALUES
	 ('2023-06-24','yandex','cpc','prof-python',164,34954,0,0,NULL),
	 ('2023-06-24','yandex','cpc','prof-java',129,29381,0,0,NULL),
	 ('2023-06-24','yandex','cpc','base-java',58,8258,0,0,NULL),
	 ('2023-06-24','yandex','cpc','base-frontend',41,NULL,0,0,NULL),
	 ('2023-06-24','yandex','cpc','base-python',40,12132,0,0,NULL),
	 ('2023-06-24','admitad','cpa','admitad',35,NULL,2,0,NULL),
	 ('2023-06-24','yandex','cpc','prof-professions-brand',35,3093,0,0,NULL),
	 ('2023-06-24','yandex','cpc','prof-data-analytics',29,5165,0,0,NULL),
	 ('2023-06-24','yandex','cpc','prof-professions-retarget',27,1017,0,0,NULL),
...
ORDER BY
    ...
    utm_campaign ASC" (visit_date,utm_source,utm_medium,utm_campaign,visitors_count,total_cost,leads_count,purchases_count,revenue) VALUES
	 ...
	 ('2023-06-24','vk','cpc','prof-python',18,5738,0,0,NULL),
	 ('2023-06-24','vk','cpc','prof-data-analytics',14,4322,0,0,NULL),
	 ...
	 ('2023-06-24','vk','cpc','prof-java',9,6347,0,0,NULL),
	 ('2023-06-24','yandex','cpc','dod-java',9,NULL,0,0,NULL),
	 ('2023-06-24','vk','cpc','prof-frontend',8,5076,0,0,NULL);
INSERT INTO "WITH last_paid_click AS (
    SELECT
        s.visitor_id,
        s.source AS utm_source,
...
ORDER BY
    ...
    utm_campaign ASC" (visit_date,utm_source,utm_medium,utm_campaign,visitors_count,total_cost,leads_count,purchases_count,revenue) VALUES
	 ...
	 ('2023-06-24','vk','cpc','base-python',7,2284,0,0,NULL),
	 ('2023-06-24','vk','cpc','freemium-python',6,2273,0,0,NULL),
	 ('2023-06-24','yandex','cpc','base-professions-retarget',6,NULL,0,0,NULL),
	 ('2023-06-24','vk','cpc','freemium-frontend',5,2539,0,0,NULL),
	 ...
	 ('2023-06-24','vk','cpc','freemium-java',2,1723,0,0,NULL);
INSERT INTO "WITH last_paid_click AS (
    SELECT
        s.visitor_id,
        s.source AS utm_source,
...
ORDER BY
    ...
    utm_campaign ASC" (visit_date,utm_source,utm_medium,utm_campaign,visitors_count,total_cost,leads_count,purchases_count,revenue) VALUES
	 ...
	 ('2023-06-25','yandex','cpc','freemium',211,14213,0,0,NULL),
	 ('2023-06-25','yandex','cpc','prof-python',157,41468,0,0,NULL),
	 ('2023-06-25','yandex','cpc','prof-java',149,37431,0,0,NULL),
	 ('2023-06-25','yandex','cpc','prof-frontend',147,57264,0,0,NULL),
	 ('2023-06-25','yandex','cpc','base-java',66,11999,0,0,NULL);
INSERT INTO "WITH last_paid_click AS (
    SELECT
        s.visitor_id,
        s.source AS utm_source,
...
ORDER BY
    ...
    utm_medium ASC,
    utm_campaign ASC" (visit_date,utm_source,utm_medium,utm_campaign,visitors_count,total_cost,leads_count,purchases_count,revenue) VALUES
	 ('2023-06-25','yandex','cpc','base-python',61,8006,0,0,NULL),
	 ('2023-06-25','admitad','cpa','admitad',49,NULL,0,0,NULL),
	 ('2023-06-25','yandex','cpc','prof-professions-brand',46,5162,0,0,NULL),
	 ('2023-06-25','yandex','cpc','base-frontend',40,NULL,0,0,NULL),
	 ('2023-06-25','yandex','cpc','prof-professions-retarget',29,919,0,0,NULL),
	 ('2023-06-25','vk','cpc','prof-python',25,6042,0,0,NULL),
	 ('2023-06-25','yandex','cpc','prof-data-analytics',23,4694,0,0,NULL),
	 ('2023-06-25','yandex','cpc','dod-frontend',22,NULL,0,0,NULL),
	 ('2023-06-25','vk','cpc','prof-java',21,9138,0,0,NULL),
...
ORDER BY
    ...
    utm_medium ASC,
    utm_campaign ASC" (visit_date,utm_source,utm_medium,utm_campaign,visitors_count,total_cost,leads_count,purchases_count,revenue) VALUES
	 ('2023-06-25','vk','cpc','prof-data-analytics',14,3807,0,0,NULL),
	 ('2023-06-25','yandex','cpc','dod-professions',12,NULL,0,0,NULL),
	 ('2023-06-25','vk','cpc','base-python',10,3522,0,0,NULL),
	 ('2023-06-25','yandex','cpc','dod-java',9,NULL,0,0,NULL),
	 ('2023-06-25','vk','cpc','freemium-frontend',8,2538,0,0,NULL),
	 ('2023-06-25','vk','cpc','freemium-python',7,2085,0,0,NULL),
...
ORDER BY
    ...
    utm_campaign ASC" (visit_date,utm_source,utm_medium,utm_campaign,visitors_count,total_cost,leads_count,purchases_count,revenue) VALUES
	 ...
	 ('2023-06-25','vk','cpc','prof-frontend',3,6091,0,0,NULL),
	 ...
	 ('2023-06-25','vk','cpc','freemium-java',2,1523,0,0,NULL),
...
ORDER BY
    ...
    utm_campaign ASC" (visit_date,utm_source,utm_medium,utm_campaign,visitors_count,total_cost,leads_count,purchases_count,revenue) VALUES
	 ...
	 ('2023-06-26','yandex','cpc','freemium',251,16668,0,0,NULL),
	 ('2023-06-26','yandex','cpc','prof-python',187,41547,0,0,NULL),
	 ('2023-06-26','yandex','cpc','prof-frontend',166,59123,0,0,NULL),
	 ('2023-06-26','yandex','cpc','prof-java',121,35429,0,0,NULL),
	 ...
	 ('2023-06-26','yandex','cpc','base-python',57,7940,0,0,NULL),
	 ('2023-06-26','yandex','cpc','base-java',52,10728,0,0,NULL);
INSERT INTO "WITH last_paid_click AS (
    SELECT
        s.visitor_id,
        s.source AS utm_source,
...
ORDER BY
    ...
    utm_campaign ASC" (visit_date,utm_source,utm_medium,utm_campaign,visitors_count,total_cost,leads_count,purchases_count,revenue) VALUES
	 ...
	 ('2023-06-26','yandex','cpc','prof-professions-brand',40,4286,0,0,NULL),
	 ('2023-06-26','yandex','cpc','prof-data-analytics',36,4699,0,0,NULL),
	 ('2023-06-26','vk','cpc','prof-python',21,5803,0,0,NULL),
	 ('2023-06-26','yandex','cpc','dod-frontend',19,NULL,0,0,NULL),
	 ('2023-06-26','yandex','cpc','dod-professions',19,NULL,0,0,NULL),
	 ('2023-06-26','yandex','cpc','prof-professions-retarget',18,1431,0,0,NULL),
	 ('2023-06-26','vk','cpc','prof-java',17,7992,0,0,NULL),
...
ORDER BY
    ...
    utm_campaign ASC" (visit_date,utm_source,utm_medium,utm_campaign,visitors_count,total_cost,leads_count,purchases_count,revenue) VALUES
	 ...
	 ('2023-06-26','vk','cpc','freemium-frontend',8,2538,0,0,NULL),
	 ('2023-06-26','vk','cpc','freemium-python',7,1967,0,0,NULL),
	 ...
	 ('2023-06-26','vk','cpc','prof-data-analytics',4,1401,0,0,NULL),
	 ('2023-06-26','vk','cpc','prof-frontend',4,4319,0,0,NULL),
...
ORDER BY
    ...
    utm_campaign ASC" (visit_date,utm_source,utm_medium,utm_campaign,visitors_count,total_cost,leads_count,purchases_count,revenue) VALUES
	 ...
	 ('2023-06-26','vk','cpc','base-python',3,1886,0,0,NULL),
...
ORDER BY
    ...
    utm_campaign ASC" (visit_date,utm_source,utm_medium,utm_campaign,visitors_count,total_cost,leads_count,purchases_count,revenue) VALUES
	 ...
	 ('2023-06-27','yandex','cpc','freemium',238,13694,0,0,NULL);
INSERT INTO "WITH last_paid_click AS (
    SELECT
        s.visitor_id,
        s.source AS utm_source,
...
ORDER BY
    ...
    utm_medium ASC,
    utm_campaign ASC" (visit_date,utm_source,utm_medium,utm_campaign,visitors_count,total_cost,leads_count,purchases_count,revenue) VALUES
	 ('2023-06-27','yandex','cpc','prof-python',175,39939,0,0,NULL),
	 ('2023-06-27','yandex','cpc','prof-frontend',158,60963,0,0,NULL),
	 ('2023-06-27','yandex','cpc','prof-java',128,28235,0,0,NULL),
	 ('2023-06-27','yandex','cpc','base-java',58,5584,0,0,NULL),
	 ('2023-06-27','yandex','cpc','base-python',58,10271,0,0,NULL),
	 ('2023-06-27','yandex','cpc','prof-professions-brand',58,5257,0,0,NULL),
	 ('2023-06-27','admitad','cpa','admitad',45,NULL,0,0,NULL),
	 ('2023-06-27','yandex','cpc','base-frontend',39,NULL,0,0,NULL),
	 ('2023-06-27','yandex','cpc','prof-data-analytics',38,7092,0,0,NULL),
	 ('2023-06-27','yandex','cpc','prof-professions-retarget',32,669,0,0,NULL);
INSERT INTO "WITH last_paid_click AS (
    SELECT
        s.visitor_id,
        s.source AS utm_source,
...
ORDER BY
    ...
    utm_medium ASC,
    utm_campaign ASC" (visit_date,utm_source,utm_medium,utm_campaign,visitors_count,total_cost,leads_count,purchases_count,revenue) VALUES
	 ('2023-06-27','vk','cpc','base-python',9,2410,0,0,NULL),
	 ('2023-06-27','vk','cpc','prof-java',9,5394,0,0,NULL),
	 ('2023-06-27','yandex','cpc','dod-java',9,NULL,0,0,NULL),
	 ('2023-06-27','vk','cpc','freemium-python',7,2015,0,0,NULL),
	 ('2023-06-27','vk','cpc','prof-frontend',5,6660,0,0,NULL),
	 ...
	 ('2023-06-27','vk','cpc','freemium-java',2,1523,0,0,NULL);
INSERT INTO "WITH last_paid_click AS (
    SELECT
        s.visitor_id,
        s.source AS utm_source,
...
ORDER BY
    ...
    utm_campaign ASC" (visit_date,utm_source,utm_medium,utm_campaign,visitors_count,total_cost,leads_count,purchases_count,revenue) VALUES
	 ...
	 ('2023-06-28','yandex','cpc','freemium',239,15892,0,0,NULL),
	 ('2023-06-28','yandex','cpc','prof-python',186,44881,0,0,NULL),
	 ('2023-06-28','yandex','cpc','prof-frontend',139,65708,0,0,NULL),
	 ('2023-06-28','yandex','cpc','prof-java',112,29048,0,0,NULL),
	 ('2023-06-28','admitad','cpa','admitad',75,NULL,0,0,NULL),
	 ('2023-06-28','yandex','cpc','base-python',60,9590,0,0,NULL);
INSERT INTO "WITH last_paid_click AS (
    SELECT
        s.visitor_id,
        s.source AS utm_source,
...
ORDER BY
    ...
    utm_medium ASC,
    utm_campaign ASC" (visit_date,utm_source,utm_medium,utm_campaign,visitors_count,total_cost,leads_count,purchases_count,revenue) VALUES
	 ('2023-06-28','yandex','cpc','base-java',47,10709,0,0,NULL),
	 ('2023-06-28','yandex','cpc','base-frontend',43,NULL,0,0,NULL),
	 ('2023-06-28','yandex','cpc','prof-professions-brand',34,4791,0,0,NULL),
	 ('2023-06-28','telegram','cpp','base-python',32,NULL,0,0,NULL),
	 ('2023-06-28','yandex','cpc','prof-data-analytics',27,6179,0,0,NULL),
	 ('2023-06-28','yandex','cpc','prof-professions-retarget',27,1415,0,0,NULL),
	 ...
	 ('2023-06-28','vk','cpc','prof-python',15,4318,0,0,NULL);
INSERT INTO "WITH last_paid_click AS (
    SELECT
        s.visitor_id,
        s.source AS utm_source,
...
ORDER BY
    ...
    utm_medium ASC,
    utm_campaign ASC" (visit_date,utm_source,utm_medium,utm_campaign,visitors_count,total_cost,leads_count,purchases_count,revenue) VALUES
	 ('2023-06-28','vk','cpc','freemium-frontend',14,2538,0,0,NULL),
	 ...
	 ('2023-06-28','vk','cpc','freemium-python',8,1954,1,0,NULL),
	 ('2023-06-28','vk','cpc','prof-java',8,5757,0,0,NULL),
	 ('2023-06-28','yandex','cpc','dod-qa',8,2239,0,0,NULL),
	 ('2023-06-28','vk','cpc','base-python',7,2706,0,0,NULL),
	 ('2023-06-28','vk','cpc','prof-frontend',6,6628,0,0,NULL);
INSERT INTO "WITH last_paid_click AS (
    SELECT
        s.visitor_id,
        s.source AS utm_source,
...
ORDER BY
    ...
    utm_campaign ASC" (visit_date,utm_source,utm_medium,utm_campaign,visitors_count,total_cost,leads_count,purchases_count,revenue) VALUES
	 ...
	 ('2023-06-28','vk','cpc','freemium-java',3,1521,0,0,NULL),
...
ORDER BY
    ...
    utm_medium ASC,
    utm_campaign ASC" (visit_date,utm_source,utm_medium,utm_campaign,visitors_count,total_cost,leads_count,purchases_count,revenue) VALUES
	 ('2023-06-29','yandex','cpc','freemium',227,14981,0,0,NULL),
	 ('2023-06-29','yandex','cpc','prof-python',194,45967,0,0,NULL),
	 ('2023-06-29','yandex','cpc','prof-frontend',149,65499,0,0,NULL),
	 ('2023-06-29','yandex','cpc','prof-java',122,35170,0,0,NULL),
	 ('2023-06-29','yandex','cpc','base-python',61,16174,0,0,NULL),
	 ('2023-06-29','admitad','cpa','admitad',56,NULL,0,0,NULL),
	 ('2023-06-29','yandex','cpc','base-java',49,11606,0,0,NULL),
	 ('2023-06-29','vk-senler','cpc','base-python',46,NULL,0,0,NULL),
	 ('2023-06-29','telegram','cpp','base-python',43,NULL,0,0,NULL),
	 ('2023-06-29','yandex','cpc','prof-professions-brand',37,3262,0,0,NULL);
INSERT INTO "WITH last_paid_click AS (
    SELECT
        s.visitor_id,
        s.source AS utm_source,
...
ORDER BY
    ...
    utm_medium ASC,
    utm_campaign ASC" (visit_date,utm_source,utm_medium,utm_campaign,visitors_count,total_cost,leads_count,purchases_count,revenue) VALUES
	 ('2023-06-29','yandex','cpc','base-frontend',35,4003,0,0,NULL),
	 ('2023-06-29','yandex','cpc','prof-data-analytics',29,NULL,0,0,NULL),
	 ('2023-06-29','yandex','cpc','prof-professions-retarget',25,903,0,0,NULL),
	 ('2023-06-29','vk','cpc','freemium-frontend',20,2538,0,0,NULL),
	 ...
	 ('2023-06-29','vk','cpc','prof-python',13,4303,0,0,NULL),
...
ORDER BY
    ...
    utm_medium ASC,
    utm_campaign ASC" (visit_date,utm_source,utm_medium,utm_campaign,visitors_count,total_cost,leads_count,purchases_count,revenue) VALUES
	 ('2023-06-29','yandex','cpc','dod-qa',5,7291,0,0,NULL),
	 ...
	 ('2023-06-29','vk','cpc','base-python',3,2511,0,0,NULL),
	 ...
	 ('2023-06-29','vk','cpc','freemium-java',2,1523,0,0,NULL);
INSERT INTO "WITH last_paid_click AS (
    SELECT
        s.visitor_id,
        s.source AS utm_source,
...
ORDER BY
    ...
    utm_medium ASC,
    utm_campaign ASC" (visit_date,utm_source,utm_medium,utm_campaign,visitors_count,total_cost,leads_count,purchases_count,revenue) VALUES
	 ('2023-06-29','yandex','cpc','base-professions-retarget',2,378,0,0,NULL),
...
ORDER BY
    ...
    utm_campaign ASC" (visit_date,utm_source,utm_medium,utm_campaign,visitors_count,total_cost,leads_count,purchases_count,revenue) VALUES
	 ...
	 ('2023-06-30','yandex','cpc','freemium',200,17861,0,0,NULL),
	 ('2023-06-30','yandex','cpc','prof-python',179,37628,0,0,NULL),
	 ('2023-06-30','yandex','cpc','prof-frontend',165,53195,0,0,NULL),
	 ('2023-06-30','yandex','cpc','prof-java',125,37068,0,0,NULL),
	 ('2023-06-30','yandex','cpc','base-python',77,11174,0,0,NULL),
	 ('2023-06-30','admitad','cpa','admitad',71,NULL,0,0,NULL),
	 ('2023-06-30','yandex','cpc','base-java',64,7338,0,0,NULL),
	 ('2023-06-30','yandex','cpc','prof-professions-brand',43,2821,0,0,NULL),
	 ('2023-06-30','yandex','cpc','base-frontend',37,8231,0,0,NULL);
INSERT INTO "WITH last_paid_click AS (
    SELECT
        s.visitor_id,
        s.source AS utm_source,
...
ORDER BY
    ...
    utm_campaign ASC" (visit_date,utm_source,utm_medium,utm_campaign,visitors_count,total_cost,leads_count,purchases_count,revenue) VALUES
	 ...
	 ('2023-06-30','yandex','cpc','prof-professions-retarget',19,1295,0,0,NULL),
	 ...
	 ('2023-06-30','vk','cpc','prof-java',14,7529,0,0,NULL),
...
ORDER BY
    ...
    utm_campaign ASC" (visit_date,utm_source,utm_medium,utm_campaign,visitors_count,total_cost,leads_count,purchases_count,revenue) VALUES
	 ...
	 ('2023-06-30','yandex','cpc','base-professions-retarget',5,608,0,0,NULL),
	 ('2023-06-30','yandex','cpc','dod-php',5,NULL,0,0,NULL),
	 ('2023-06-30','yandex','cpc','dod-qa',5,6510,0,0,NULL),
	 ('2023-06-30','vk','cpc','freemium-java',4,1524,0,0,NULL),
	 ('2023-06-30','vk','cpc','base-python',3,2284,0,0,NULL),
